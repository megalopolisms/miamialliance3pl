...
## STEP 2: Get Added as Admin

**JORGE - Reply to Yuri with:**

```
I want to use this Google account for Analytics:

Email: [YOUR GOOGLE EMAIL HERE]

Please add me as admin to the GA4 property.
```
...
1. Go to: https://analytics.google.com
2. Select "Miami Alliance 3PL" property
3. Click "Realtime" in left menu
4. Open miamialliance3pl.com in another tab
5. You should see "1 user" in realtime dashboard
